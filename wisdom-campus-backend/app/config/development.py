...
# Auth0配置
AUTH0_DOMAIN = os.environ.get('AUTH0_DOMAIN', 'dev-example.us.auth0.com')
...
AUTH0_AUDIENCE = os.environ.get('AUTH0_AUDIENCE', 'https://dev-example.us.auth0.com/api/v2/')

# 确保 Auth0 API Audience 正确
AUTH0_API_AUDIENCE = os.environ.get('AUTH0_API_AUDIENCE', AUTH0_AUDIENCE)
...
AUTH0_TEST_MODE = False  # 永久禁用测试模式，使用真实Auth0验证
